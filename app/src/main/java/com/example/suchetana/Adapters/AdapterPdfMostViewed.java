...
public class AdapterPdfMostViewed extends RecyclerView.Adapter<AdapterPdfMostViewed.HolderPdf> {
    ...
    public AdapterPdfMostViewed(Context context, ArrayList<ModelPdf> pdfArrayList) {
    ...
    public HolderPdf onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterPdfMostViewed.HolderPdf(binding.getRoot());
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterPdfMostViewed.HolderPdf holder, int position) {
        //get data
