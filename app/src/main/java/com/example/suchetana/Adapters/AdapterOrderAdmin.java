...
public class AdapterOrderAdmin extends RecyclerView.Adapter<AdapterOrderAdmin.HolderOrder> {
    //context
    ...
    public AdapterOrderAdmin(Context context, ArrayList<ModelOrder> orderArrayList) {
    ...
    @NotNull
    @Override
    public AdapterOrderAdmin.HolderOrder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        binding = RowOrdersBinding.inflate(LayoutInflater.from(context), parent, false);
        return new AdapterOrderAdmin.HolderOrder(binding.getRoot());
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull AdapterOrderAdmin.HolderOrder holder, int position) {
    ...
    private void loadBookDetails(ModelOrder model, AdapterOrderAdmin.HolderOrder holder) {
